...
import com.example.justeatituser.Remote.RetrofitGoogleAPIClient
...
class TrackingOrderActivity : AppCompatActivity(), OnMapReadyCallback, ValueEventListener {
    ...
    private fun drawRoutes() {
        ...
        if (shipperMarker == null)
        {
            val height = 80
            val width = 80
            val bitmapDrawable = ContextCompat.getDrawable(this@TrackingOrderActivity,R.drawable.point)
            as BitmapDrawable
